...
//                 <div>
//                     <div>
//                         <button className="btn btn-neutral w-full p-5" onClick={handleGoogleLogin}>
//                             Login with Google
//                         </button>

//                         {/* Check if user exists and has a displayName */}
//                         {/* {user && (
//                             <div>
//                                 <h4>{user.email ? user.displayName : user.email}</h4>
//                             </div>
//                         )} */}
//                     </div>


//                     <button className="btn btn-neutral w-full p-5 mt-4" onClick={loginWithGithub}>
//                         Login with Github
//                     </button>
...
//                                 src={user.photoURL}
//                                 alt="User profile"
//                                 className="w-16 h-16 rounded-full mx-auto border-2 border-gray-400"
//                             />
//                             {user.displayName && (
//                                 <div className="absolute bottom-[-40px] left-1/2 transform -translate-x-1/2 bg-black text-white text-sm px-3 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300">
//                                     {user.displayName}
//                                 </div>
//                             )}
//                         </div>
